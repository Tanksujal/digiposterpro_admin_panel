...
const GetFeedback = () => {
  ...
  useEffect(() => {
    ...
    const fetchFeedbacks = async () => {
      try {
        const response = await axios.get(`${apiurl}/feedback/getFeedback`); // Replace with your endpoint
        if (response.data.success) {
            console.log(response.data.feedbacks);
            
          setFeedbacks(response.data.feedbacks); // Assuming `feedbacks` is the key in API response
        } else {
